...
var _fullcalendarObjectMapper = __webpack_require__(2);
...
var FullCalendar = function (_React$PureComponent) {
    _inherits(FullCalendar, _React$PureComponent);
    ...
    _createClass(FullCalendar, [{
        ...
        value: function createCalendar() {
            if (this.rootEl) {
                ...
                this.calendar = new _core.Calendar(this.rootEl, objectMapperSettings);
